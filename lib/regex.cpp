...
/*
   NOTE:  THIS FILE HAS BEEN SLIGHTLY MODIFIED TO COMPILE UNDER BeOS 4.5/PPC.
          Please be aware that is not quite the same as the "official" regex.cpp!
*/

#define STDC_HEADERS 1  // jaf is guessing again...
