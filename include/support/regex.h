...
/**************************************************************************
   ...
   expression library, version 0.XX. (see below--jaf)
...
/* NOTE:  This file has been modified slightly to compile under BeOS/PPC!
          Be aware that it is not the same as any "official" version --jaf
*/
...
extern int re_search_2
  _RE_ARGS ((struct re_pattern_buffer *buffer, const char *string1,
             const char *string2, int length1, int length2,
